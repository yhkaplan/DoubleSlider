Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "yhkaplan"
  # s.authors            = { "yhkaplan" => "yhkaplan@gmail.com" }
  # s.social_media_url   = "http://twitter.com/yhkaplan"
  ...
  s.source       = { :git => "https://github.com/yhkaplan/DoubleSlider.git", :tag => "#{s.version.to_s}" }
